...
Version  : 5.14.2
Release  : 24
URL      : https://download.qt.io/official_releases/qt/5.14/5.14.2/submodules/qtserialport-everywhere-src-5.14.2.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.14/5.14.2/submodules/qtserialport-everywhere-src-5.14.2.tar.xz
...
%prep
%setup -q -n qtserialport-everywhere-src-5.14.2
cd %{_builddir}/qtserialport-everywhere-src-5.14.2
...
%install
export SOURCE_DATE_EPOCH=1586201403
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/qtserialport
cp %{_builddir}/qtserialport-everywhere-src-5.14.2/LICENSE.FDL %{buildroot}/usr/share/package-licenses/qtserialport/61907422fefcd2313a9b570c31d203a6dbebd333
cp %{_builddir}/qtserialport-everywhere-src-5.14.2/LICENSE.GPL2 %{buildroot}/usr/share/package-licenses/qtserialport/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/qtserialport-everywhere-src-5.14.2/LICENSE.GPL3 %{buildroot}/usr/share/package-licenses/qtserialport/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/qtserialport-everywhere-src-5.14.2/LICENSE.GPL3-EXCEPT %{buildroot}/usr/share/package-licenses/qtserialport/e93757aefa405f2c9a8a55e780ae9c39542dfc3a
cp %{_builddir}/qtserialport-everywhere-src-5.14.2/LICENSE.LGPL3 %{buildroot}/usr/share/package-licenses/qtserialport/f45ee1c765646813b442ca58de72e20a64a7ddba
%make_install
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtSerialPort/5.14.2/QtSerialPort/private/qserialport_p.h
/usr/include/qt5/QtSerialPort/5.14.2/QtSerialPort/private/qserialportinfo_p.h
/usr/include/qt5/QtSerialPort/5.14.2/QtSerialPort/private/qtntdll_p.h
/usr/include/qt5/QtSerialPort/5.14.2/QtSerialPort/private/qtserialport-config_p.h
/usr/include/qt5/QtSerialPort/5.14.2/QtSerialPort/private/qtudev_p.h
...
/usr/lib64/libQt5SerialPort.so.5.14.2
