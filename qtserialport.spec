...
Source0  : http://download.qt.io/official_releases/qt/5.11/5.11.1/submodules/qtserialport-everywhere-src-5.11.1.tar.xz
...
%prep
%setup -q -n qtserialport-everywhere-src-5.11.1
...
%install
export SOURCE_DATE_EPOCH=1530943926
rm -rf %{buildroot}
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtSerialPort/5.11.1/QtSerialPort/private/qserialport_p.h
/usr/include/qt5/QtSerialPort/5.11.1/QtSerialPort/private/qserialportinfo_p.h
/usr/include/qt5/QtSerialPort/5.11.1/QtSerialPort/private/qtudev_p.h
/usr/include/qt5/QtSerialPort/5.11.1/QtSerialPort/private/qwinoverlappedionotifier_p.h
...
/usr/lib64/libQt5SerialPort.so.5.11.1
