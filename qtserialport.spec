...
Version  : 5.15.17
Release  : 28
URL      : https://download.qt.io/official_releases/qt/5.15/5.15.17/submodules/qtserialport-everywhere-opensource-src-5.15.17.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.15/5.15.17/submodules/qtserialport-everywhere-opensource-src-5.15.17.tar.xz
...
%prep
%setup -q -n qtserialport-everywhere-src-5.15.17
cd %{_builddir}/qtserialport-everywhere-src-5.15.17
...
ASFLAGS="$CLEAR_INTERMEDIATE_ASFLAGS"
LDFLAGS="$CLEAR_INTERMEDIATE_LDFLAGS"
export SOURCE_DATE_EPOCH=1748644769
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/qtserialport
cp %{_builddir}/qtserialport-everywhere-src-%{version}/LICENSE.FDL %{buildroot}/usr/share/package-licenses/qtserialport/61907422fefcd2313a9b570c31d203a6dbebd333 || :
cp %{_builddir}/qtserialport-everywhere-src-%{version}/LICENSE.GPL2 %{buildroot}/usr/share/package-licenses/qtserialport/4cc77b90af91e615a64ae04893fdffa7939db84c || :
cp %{_builddir}/qtserialport-everywhere-src-%{version}/LICENSE.GPL3 %{buildroot}/usr/share/package-licenses/qtserialport/8624bcdae55baeef00cd11d5dfcfa60f68710a02 || :
cp %{_builddir}/qtserialport-everywhere-src-%{version}/LICENSE.GPL3-EXCEPT %{buildroot}/usr/share/package-licenses/qtserialport/e93757aefa405f2c9a8a55e780ae9c39542dfc3a || :
cp %{_builddir}/qtserialport-everywhere-src-%{version}/LICENSE.LGPL3 %{buildroot}/usr/share/package-licenses/qtserialport/f45ee1c765646813b442ca58de72e20a64a7ddba || :
export GOAMD64=v2
GOAMD64=v2
%make_install
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtSerialPort/5.15.17/QtSerialPort/private/qserialport_p.h
/usr/include/qt5/QtSerialPort/5.15.17/QtSerialPort/private/qserialportinfo_p.h
/usr/include/qt5/QtSerialPort/5.15.17/QtSerialPort/private/qtserialport-config_p.h
/usr/include/qt5/QtSerialPort/5.15.17/QtSerialPort/private/qtudev_p.h
/usr/include/qt5/QtSerialPort/5.15.17/QtSerialPort/private/qwinoverlappedionotifier_p.h
...
/usr/lib64/libQt5SerialPort.so.5.15.17
