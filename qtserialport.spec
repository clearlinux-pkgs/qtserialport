...
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.0/submodules/qtserialport-everywhere-src-5.12.0.tar.xz
...
%prep
%setup -q -n qtserialport-everywhere-src-5.12.0
...
%install
export SOURCE_DATE_EPOCH=1544047320
rm -rf %{buildroot}
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtSerialPort/5.12.0/QtSerialPort/private/qserialport_p.h
/usr/include/qt5/QtSerialPort/5.12.0/QtSerialPort/private/qserialportinfo_p.h
/usr/include/qt5/QtSerialPort/5.12.0/QtSerialPort/private/qtudev_p.h
/usr/include/qt5/QtSerialPort/5.12.0/QtSerialPort/private/qwinoverlappedionotifier_p.h
...
/usr/lib64/libQt5SerialPort.so.5.12.0
