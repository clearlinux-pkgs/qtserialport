...
Version  : 5.12.1
Release  : 15
URL      : https://download.qt.io/official_releases/qt/5.12/5.12.1/submodules/qtserialport-everywhere-src-5.12.1.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.1/submodules/qtserialport-everywhere-src-5.12.1.tar.xz
...
%prep
%setup -q -n qtserialport-everywhere-src-5.12.1
...
%install
export SOURCE_DATE_EPOCH=1549038348
rm -rf %{buildroot}
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtSerialPort/5.12.1/QtSerialPort/private/qserialport_p.h
/usr/include/qt5/QtSerialPort/5.12.1/QtSerialPort/private/qserialportinfo_p.h
/usr/include/qt5/QtSerialPort/5.12.1/QtSerialPort/private/qtudev_p.h
/usr/include/qt5/QtSerialPort/5.12.1/QtSerialPort/private/qwinoverlappedionotifier_p.h
...
/usr/lib64/libQt5SerialPort.so.5.12.1
