...
Version  : 5.12.4
Release  : 19
URL      : https://download.qt.io/official_releases/qt/5.12/5.12.4/submodules/qtserialport-everywhere-src-5.12.4.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.4/submodules/qtserialport-everywhere-src-5.12.4.tar.xz
...
%prep
%setup -q -n qtserialport-everywhere-src-5.12.4
...
%install
export SOURCE_DATE_EPOCH=1561139625
rm -rf %{buildroot}
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtSerialPort/5.12.4/QtSerialPort/private/qserialport_p.h
/usr/include/qt5/QtSerialPort/5.12.4/QtSerialPort/private/qserialportinfo_p.h
/usr/include/qt5/QtSerialPort/5.12.4/QtSerialPort/private/qtudev_p.h
/usr/include/qt5/QtSerialPort/5.12.4/QtSerialPort/private/qwinoverlappedionotifier_p.h
...
/usr/lib64/libQt5SerialPort.so.5.12.4
