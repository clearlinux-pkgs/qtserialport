...
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.2/submodules/qtserialport-everywhere-src-5.12.2.tar.xz
...
%prep
%setup -q -n qtserialport-everywhere-src-5.12.2
...
%install
export SOURCE_DATE_EPOCH=1552681795
rm -rf %{buildroot}
...
%files dev
%defattr(-,root,root,-)
/usr/include/qt5/QtSerialPort/5.12.2/QtSerialPort/private/qserialport_p.h
/usr/include/qt5/QtSerialPort/5.12.2/QtSerialPort/private/qserialportinfo_p.h
/usr/include/qt5/QtSerialPort/5.12.2/QtSerialPort/private/qtudev_p.h
/usr/include/qt5/QtSerialPort/5.12.2/QtSerialPort/private/qwinoverlappedionotifier_p.h
...
/usr/lib64/libQt5SerialPort.so.5.12.2
